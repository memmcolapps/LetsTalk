...
class ChatItemView extends StatefulWidget {
  ...
  final Subject<MsgStreamEv<int>> clickPlayNextSubject;
  ...
  /// 播放下一个音频
  final Function(int int)? onPlayNextAudio;
  ...
  const ChatItemView(
      ...
      required this.clickPlayNextSubject,
        ...
        case MessageType.voice:
          {
            ...
            child = _buildCommonItemView(
              child: ChatVoiceView(
                ...
                onPlayNextAudio: widget.onPlayNextAudio,
                clickPlayNextStream: widget.clickPlayNextSubject.stream,
  ...
  Widget _buildCommonItemView({
    ...
    bool isHintMsg = false,
      ...
      ChatSingleLayout(
        ...
        sendTime: widget.message.sendTime!,
