...
class UILocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      "favoriteEmoji": "Added single emoji",
      "now": 'now',
      "minutes": 'a minutes',
      "hours": "a hours",
    },
  ...
  static String get favoriteEmoji => _value(key: 'favoriteEmoji');

  static String get now => _value(key: 'now');

  static String get minutes => _value(key: 'minutes');

  static String get hours => _value(key: 'hours');
}
