...
import 'package:openim_demo/src/pages/chat/chat_setup/emoji_manage/emoji_manage_binding.dart';
import 'package:openim_demo/src/pages/chat/chat_setup/emoji_manage/emoji_manage_view.dart';
import 'package:openim_demo/src/pages/chat/chat_setup/font_size/font_size_binding.dart';
import 'package:openim_demo/src/pages/chat/chat_setup/font_size/font_size_view.dart';
...
// import 'package:openim_demo/src/pages/interest/interest_binding.dart';
...
import 'package:openim_demo/src/pages/moments/moments_binding.dart';
import 'package:openim_demo/src/pages/moments/moments_view.dart';
import 'package:openim_demo/src/pages/moments/publish/publish_binding.dart';
import 'package:openim_demo/src/pages/moments/publish/publish_view.dart';
...
import 'package:openim_demo/src/pages/people_nearby/people_nearby_binding.dart';
import 'package:openim_demo/src/pages/people_nearby/people_nearby_view.dart';
...
class AppPages {
  static final routes = <GetPage>[
    ...
    GetPage(
      ...
      page: () => WxFriendsCirclePage(),
      binding: MomentsBinding(),
    ),
    GetPage(
      name: AppRoutes.MOMENTS_PUBLISH,
      page: () => PublishPage(),
    ...
    GetPage(
      name: AppRoutes.PEOPLE_NEARBY,
      page: () => PeopleNearbyPage(),
      binding: PeopleNearbyBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.SEARCH_HISTORY_FILE,
      page: () => SearchFilePage(),
      binding: SearchFileBinding(),
    ),
    GetPage(
      name: AppRoutes.SEARCH_HISTORY_PICTURE,
