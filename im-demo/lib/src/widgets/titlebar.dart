...
class EnterpriseTitleBar extends StatelessWidget
  ...
  EnterpriseTitleBar.momentTitle({
    String? title,
    String? subTitle,
    double? height,
    String? leftButton,
  ...
  EnterpriseTitleBar.centerTitle({
    String? title,
    Color? backgroundColor,
    this.left,
    this.right,
        ...
        center = Column(
          ...
          children: [
            if (null != title)
              Text(
                title,
                style: PageStyle.ts_1B72EC_20sp,
              ),
          ],
        );
  EnterpriseTitleBar.leftTitle({
    ...
    Color? backgroundColor,
        ...
        left = Container(
          ...
          child: Text(
            title ?? '',
            style: textStyle ?? PageStyle.ts_1B72EC_20sp,
          ),
        );

  EnterpriseTitleBar.searchTitle(
      {required SearchBox searchBox, TextStyle? cancelTextStyle})
      : //height = 107.h,
        // topPadding = 54.h,
        height = 53.h,
        topPadding = 0,
