...
class StrRes {
  ...
  static get peopleNearby => 'peopleNearby'.tr;

  static get likeMoments => 'like'.tr;

  static get nlikeMoments => 'nlike'.tr;

  static get commentMoments => 'comment'.tr;

  static get momentsPublish => 'momentsPublish'.tr;

  static get momentsDone => 'momentsDone'.tr;

  static get publishText => 'publishText'.tr;

  static get publishImages => 'publishImages'.tr;

  static get plsInputComment => 'plsInputComment'.tr;
  ...
  static get areYouSureOpenPeopleNearby => 'areYouSureOpenPeopleNearby'.tr;

  static get nullPeopleNearby => 'nullPeopleNearby'.tr;
  ...
  static get naijaLanguages => 'naijaLanguages'.tr;

  static get hausaLanguages => 'hausaLanguages'.tr;

  static get igboLanguages => 'igboLanguages'.tr;

  static get yorubaLanguages => 'yorubaLanguages'.tr;

  static get pidginLanguages => 'pidginLanguages'.tr;

  static get frenchLanguages => 'frenchLanguages'.tr;

  static get germanLanguages => 'germanLanguages'.tr;

  static get notEnabledLanguages => 'notEnabledLanguages'.tr;

  static get notEnabledFunction => 'notEnabledFunction'.tr;
  ...
  static get confirmClearHistoryMessage => 'confirmClearHistoryMessage'.tr;
  ...
  static get interest => 'interest'.tr;
  ...
  static get plsWaiting => 'plsWaiting'.tr;
  ...
  static get isThisDay => 'isThisDay'.tr;

  static get isThisWeek => 'thisWeek'.tr;

  static get confirmResend => 'confirmResend'.tr;

  static get chatFavorite => 'chatFavorite'.tr;

  static get chatFavoriteManage => 'chatFavoriteManage'.tr;

  static get peopleNearbyFail => 'peopleNearbyFail'.tr;

  static get kindTips => 'kindTips'.tr;

  static get and => 'and'.tr;

  static get plsReadAgree => 'plsReadAgree'.tr;

  static get userPrivateProtocol => 'userPrivateProtocol'.tr;
}
