...
class PageStyle {
  ...
  static const c_008069 = Color(0xFF008069);
  static const c_008000 = Color(0xFF008000);
  static const c_003F38 = Color(0xFF003F38);
  ...
  static var ts_333333_16sp = TextStyle(
      fontSize: 14.sp, color: Color(0xFF333333), fontWeight: FontWeight.w300);
  ...
  static var ts_003F38_12sp = TextStyle(
    fontSize: 12.sp,
    color: Color(0xFF003F38),
  );
  static var ts_003F38_14sp = TextStyle(
    color: Color(0xFF003F38),
    fontWeight: FontWeight.bold,
    fontSize: 14.sp,
  );
  static var ts_003F38_16sp = TextStyle(
    fontSize: 16.sp,
    color: Color(0xFF003F38),
  );
  static var ts_003F38_20sp = TextStyle(
    fontSize: 20.sp,
    color: Color(0xFF003F38),
  );

  static var ts_008069_12sp = TextStyle(
    fontSize: 12.sp,
    color: Color(0xFF008069),
  );
  static var ts_008069_14sp = TextStyle(
    fontSize: 14.sp,
    color: Color(0xFF008069),
  );
  static var ts_008069_16sp = TextStyle(
    fontSize: 16.sp,
    color: Color(0xFF008069),
  );
  static var ts_008069_20sp = TextStyle(
    fontSize: 20.sp,
    color: Color(0xFF008069),
  );
  ...
  static var ts_1B72EC_20sp = TextStyle(
    color: Color(0xFF1B72EC),
    fontSize: 20.sp,
  );
