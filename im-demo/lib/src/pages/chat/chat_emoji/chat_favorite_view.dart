...
class ChatFavoritePage extends StatelessWidget {
  final logic = Get.find<ChatFavoriteLogic>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: EnterpriseTitleBar.back(
            title: StrRes.chatFavorite, actions: [_buildSendButton()]),
        body: SafeArea(
          child: Column(
            children: [
              // _buildGroupInfoView(),
        ...
        child: Ink(
          child: InkWell(
            ...
            child: Container(
              ...
              child: Text(
                logic.isManage.value
                    ? StrRes.cancel
                    : StrRes.chatFavoriteManage,
                style: PageStyle.ts_000000_16sp,
              ),
            ),
          ),
        ),
